...
# CONTROLE DE FUROS
    ...
    if not df_furos_full.empty:
        with st.expander("🗑️ Excluir Furo Cadastrado"):
            ...
            st.warning("⚠️ Atenção: Ao excluir um furo, todos os apontamentos e boletins geológicos associados serão removidos.")
...
# BOLETIM GEOLÓGICO
    ...
    if df_furos.empty:
        st.warning("Cadastre um furo em 'Controle de Furos' antes de registrar dados geológicos.")
        conn.close()
    else:
